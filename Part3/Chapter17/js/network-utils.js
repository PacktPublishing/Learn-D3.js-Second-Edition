 ...
 */
export function matrixToLinks(nodes, matrix, objectID) {
 ...
 *          ]}
 */
export function linksToMatrix (nodes, links, objectID) {
 ...
 *
 * const matrixLayout = ntw.adjacencyMatrix()
 *                         .size([800,600]);
 *
...
export function squareGrid() {
    ...
    function layout(n, e) {
        ...
        const rollups = d3.rollups(nodes, v => v[0], d => d.node);
        const groups = nest(rollups, 1);
