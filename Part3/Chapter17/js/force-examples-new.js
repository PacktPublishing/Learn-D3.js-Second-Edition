...
export function grid(dim, nodes) {
    // Initial position in grid
    const step = (dim.width - dim.margin) * cols / (nodes.length);
...
export function drawReferenceBackgroundGrid(svg, dim, nodes, links) {
    drawReferenceBackground(svg, grid, nodes, links)
}

export function drawReferenceBackgroundCenter(svg, dim, nodes) {
    drawReferenceBackground(svg, center, nodes)
}

function drawReferenceBackground(svg, dim, reference, nodes, links) {
...
function drawGuidelinesX(chart, value) {
...
function drawGuidelinesY(chart, value) {
    chart.append("line").attr("class", "center")
...
function drawGuidecircle(chart, radius) {
